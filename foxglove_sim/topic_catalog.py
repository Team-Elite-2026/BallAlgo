...
TOPICS: tuple[FoxgloveTopic, ...] = (
    ...
    FoxgloveTopic(
        name="/traj/target",
        schema="ballalgo.TrajectoryTarget",
        panel="Plot or Raw Messages panel",
        nominal_hz=30.0,
        producer="trajectory planner / replay runner",
        purpose="Current time-indexed command sample selected from the active or replayed action chunk.",
    ),
    FoxgloveTopic(
        name="/traj/teensy_raw",
        schema="ballalgo.TeensyRawTelemetry",
        panel="Plot or Raw Messages panel",
        nominal_hz=30.0,
        producer="robot serial bridge",
        purpose="Raw Teensy telemetry as received on the Pi before higher-level estimator processing.",
    ),
    FoxgloveTopic(
        name="/traj/error",
        schema="ballalgo.TrajectoryTrackingError",
        panel="Plot panel",
        nominal_hz=30.0,
        producer="trajectory debug publisher",
        purpose="Requested-versus-measured tracking error for velocity, acceleration, and omega.",
    ),
    FoxgloveTopic(
        name="/lidar/points",
