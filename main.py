...
def _control_intent(seq: int, detections: FrameDetections, telemetry: TeensyTelemetry) -> dict[str, Any]:
    return {
        "seq": seq,
        ...
        "ball_angle_deg": detections.ball_angle_deg,
        "ball_distance_cm": detections.ball_distance_cm,
        "blue_goal_found": detections.blue_goal.found,
        "blue_goal_angle_deg": detections.blue_goal_angle_deg,
        "yellow_goal_found": detections.yellow_goal.found,
        "yellow_goal_angle_deg": detections.yellow_goal_angle_deg,
    }
        ...
        while True:
            ...
            if foxglove is not None:
                ...
                foxglove.publish(
                    ...
                    control_intent=_control_intent(loop_count, detections, telemetry),
